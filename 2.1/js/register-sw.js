         ...
         if(('PushManager' in window)){
            ...
            .then(registration => {
               registration.pushManager.subscribe({
                  ...
                  applicationServerKey: urlBase64ToUint8Array("BCwMILN5g1nFl3NkqiecEV0gtXWjQVn68TKqVvWeOZmg4Z2arsYQv86Lq0x71KNWu567ouGdjBtG2SsAK915YJo")
               })
               .then(subscribe => {
                  console.log(`Berhasil melakukan subscribe dengan entpoint: ${subscribe.endpoint}`);
